...
class NoteService {
  ...
  list(user) {
    console.log("List Notes Method Service");
  ...
  update(index, note, user) {
    console.log("Update Method Service");
    return this.init().then(() => {
      if (typeof this.notes[user] === "undefined") {
        throw new Error(
      ...
      if (this.notes[user].length <= index) {
        throw new Error(
          "Cannot update a note that doesn't exist"
        );
      }
  ...
  remove(index, user) {
    console.log("Remove Note Method");
    return this.init().then(() => {
      if (typeof this.notes[user] === "undefined") {
        throw new Error(
          "Cannot remove a note, if the user doesn't exist"
        );
      }
      if (this.notes[user].length <= index) {
        throw new Error(
          "Cannot remove a note that doesn't exist"
        );
      }
